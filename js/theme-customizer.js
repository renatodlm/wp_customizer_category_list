...
jQuery(window).load(function() {
    ...
    jQuery('.rlmdev90-hidden-categories').each(function(){
        ...
        jQuery('#' + id).closest('li').find('.rlmdev90-category-checkbox').each(function() {
    ...
    jQuery('.rlmdev90-category-checkbox').on('change', function(){
 
        var id = jQuery(this).closest('li').find('.rlmdev90-hidden-categories').prop('id');
        var elementID = jQuery(this).prop('id').split('-');
